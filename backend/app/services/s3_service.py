...
class S3Service:
    ...
    def upload_file_obj(self, file_object: BinaryIO, bucket_name: str, object_key: str) -> str | None:
        ...
        self.client.upload_fileobj(Fileobj=file_object, Bucket=bucket_name, Key=object_key, ExtraArgs=extra)

    def download_file_obj(self, file_object: BinaryIO, bucket_name: str, object_key: str):
        self.client.download_fileobj(Bucket=bucket_name, Key=object_key, Fileobj=file_object)
